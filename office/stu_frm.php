  ...
  session_start();
	...
	if($action=="1"){
		...
		if($save==1){
			...
			if($id !=""){
				$sql="update member set name='$name' , surname='$surname' , nickname='$nickname' , email='$email' ";
				$sql=$sql . " , telephone='$telephone' , gender='$gender' , address='$address' , birthday='$birthday' ";
				$sql=$sql . " , pass='$pass' , username='$username',parents_name='$parents_name',parents_tel='$parents_tel'  where member_id=$id ";
			}else{
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
          ...
          <tr>
            <td><strong><a href="member.php">รายชื่อนักเรียน</a></strong></td>
          ...
          <tr>
            <td colspan="2"><form id="form1" name="form1" method="post" action="stu_frm.php">
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="username" type="text" id="username" value="<?php echo $username ?>" />
                    <span class="t10r">*
                      <?php
					if($action=="1"){
						if($username==""){
                ...
                <tr>
                  ...
                  <td><input name="pass" type="password" id="pass" value="<?php echo $pass ?>" />
                    <span class="t10r">*
                      <?php
					if($action=="1"){
						if($pass==""){
                ...
                <tr>
                  ...
                  <td><input name="re_pass" type="password" id="re_pass" value="<?php echo $pass ?>" />
			  ...
			  ?>
                ...
                <tr>
                  ...
                  <td><input name="parents_name" type="text" id="parents_name" value="<?php echo $parents_name ?>" /></td>
                </tr>
                <tr>
                  <td align="right">เบอร์โทรผู้ปกครอง :</td>
                  <td><input name="parents_tel" type="text" id="parents_tel" value="<?php echo $parents_tel ?>" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
