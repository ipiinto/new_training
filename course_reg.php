...
//-->
    ...
    function priza(item,value){
        ...
        //alert(total);
        document.getElementById('Totalcost').innerHTML = "<u>" + total + "&nbsp;</u><strong>บาท</strong> ";
    }
</script>
    			...
    			<table width="100%" border="0" cellspacing="2" cellpadding="2">
      				<tr>
        				<td><strong>ลงทะเบียนเรียน</strong></td>
		    				...
		    				<tr>
		        				<td>
		        					<form id="form1" name="form1" method="post" action="chk_course_regis.php">
		          						<table width="100%" border="0" cellspacing="2" cellpadding="2">
		            						<tr>
		            						...
		            						<tr>
		              							<td colspan="2" align="right"><a href="#" onClick="select_all('sub_id', '1');">เลือกทั้งหมด</a> | <a href="#" onClick="select_all('sub_id','0');">ไม่เลือกเลย</a></td>
		              							<td>&nbsp;</td>
		            						</tr>
		            						<hr />
								            <?php
		              ...
		              <!--</select>-->
											...
											<tr>
												...
												<td align="right"><div id="Totalcost"></div></td>
											</tr>
											<tr>
												<td colspan="3">
													<hr size="5" />
	      				...
	      				<!-- End -->
      						<tr>
        						<td align="right" class="t10r">** หมายเหตุ - ราคานี้ยังไม่รวมส่วนลดของหลักสูตรหากมีการจองทั้งหลักสูตร</td>
      						</tr>
    					</table>
    				</td>
      			</tr>
